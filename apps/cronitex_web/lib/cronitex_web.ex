defmodule CronitexWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: CronitexWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/cronitex_web/templates",
        namespace: CronitexWeb
  ...
  defp view_helpers do
    quote do
      ...
      import CronitexWeb.ErrorHelpers
      import CronitexWeb.Gettext
      alias CronitexWeb.Router.Helpers, as: Routes
    end
  end
